            ...
            <div className=' flex justify-evenly items-center mt-20 mb-20 max-w-7xl mx-auto gap-10  text-white py-12' >
                ...
                <div className=' w-1/2 h-80 rounded-lg overflow-hidden  p-6 bg-Lightcolor'>
                    <div>
                        ...
                        <p className='text-gray-50 mt-3'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Optio sint doloribus sed assumenda illo perferendis dignissimos magni ipsa natus asperiores rerum facilis earum dolores corporis corrupti est, nostrum aperiam consequatur placeat expedita obcaecati possimus tempore.</p>
                    </div>
